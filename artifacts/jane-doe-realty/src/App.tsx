...
const FALLBACK_PROPERTIES = [
  { id: "1", title: "Diamond Head Oceanfront Estate", address: "3200 Diamond Head Rd", city: "Honolulu", state: "HI", zip: "96815", price: 4750000, bedrooms: 5, bathrooms: 4, sqft: 4800, status: "Active", featured: true, type: "Luxury", images: [{url: "https://images.unsplash.com/photo-1613490493576-7fde63acd811?w=800&q=80", isPrimary: true}], description: "Breathtaking 180-degree ocean views from this newly renovated estate perched above Diamond Head. Floor-to-ceiling windows, infinity pool, and private beach access." },
  { id: "2", title: "Kailua Beach Modern Villa", address: "450 Kawailoa Rd", city: "Kailua", state: "HI", zip: "96734", price: 3200000, bedrooms: 4, bathrooms: 3, sqft: 3600, status: "Active", featured: true, type: "Single Family", images: [{url: "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800&q=80", isPrimary: true}], description: "Steps from Kailua Beach, this modern villa seamlessly blends indoor-outdoor living with a gourmet kitchen, resort-style pool, and lush tropical landscaping." },
  { id: "3", title: "Manoa Valley Plantation Home", address: "3845 Manoa Rd", city: "Honolulu", state: "HI", zip: "96822", price: 1850000, bedrooms: 4, bathrooms: 3, sqft: 2800, status: "Active", featured: true, type: "Single Family", images: [{url: "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=800&q=80", isPrimary: true}], description: "Charming plantation-era architecture meets modern luxury in this beautifully restored Manoa home. Original hardwood floors, wraparound lanai, and mountain views." },
  { id: "4", title: "Waikiki Luxury Penthouse", address: "2120 Lauula St PH", city: "Honolulu", state: "HI", zip: "96815", price: 2400000, bedrooms: 3, bathrooms: 2, sqft: 2200, status: "Pending", featured: false, type: "Condo", images: [{url: "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=800&q=80", isPrimary: true}], description: "Top-floor penthouse with panoramic views of Waikiki Beach and Diamond Head. Private elevator, designer finishes, and five-star amenities." },
  { id: "5", title: "Hawaii Kai Waterfront", address: "7000 Hawaii Kai Dr", city: "Honolulu", state: "HI", zip: "96825", price: 2900000, bedrooms: 4, bathrooms: 3, sqft: 3200, status: "Active", featured: false, type: "Single Family", images: [{url: "https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=800&q=80", isPrimary: true}], description: "Marina-front living at its finest. Private dock, open-concept layout, and sunset views over the Koko Marina." },
  { id: "6", title: "North Shore Surf Retreat", address: "59-123 Ke Nui Rd", city: "Haleiwa", state: "HI", zip: "96712", price: 1650000, bedrooms: 3, bathrooms: 2, sqft: 1800, status: "Sold", featured: false, type: "Single Family", images: [{url: "https://images.unsplash.com/photo-1499793983690-e29da59ef1c2?w=800&q=80", isPrimary: true}], description: "Authentic surf lifestyle home just steps from Pipeline. Open-air living, outdoor shower, and the sound of waves from every room." },
];
